...
func (wireguard *Adapter) Delete(forceCloseSessions bool) (rebootRequired bool, err error) {
	var _p0 uint32
	if forceCloseSessions {
		_p0 = 1
	}
	var _p1 uint32
	r1, _, e1 := syscall.Syscall(procWireGuardDeleteAdapter.Addr(), 3, wireguard.handle, uintptr(_p0), uintptr(unsafe.Pointer(&_p1)))
