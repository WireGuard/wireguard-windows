...
var zh_TWIndex = []uint32{ // 177 elements
	...
	0x0000021e, 0x00000228, 0x00000232, 0x0000023f,
	0x0000024c, 0x00000256, 0x00000260, 0x00000269,
	0x00000276, 0x00000283, 0x00000290, 0x0000029d,
	0x000002ac, 0x000002c0, 0x000002e2, 0x00000301,
	0x0000031b, 0x00000343, 0x00000351, 0x00000361,
	// Entry 20 - 3F
	0x00000387, 0x000003a0, 0x000003bf, 0x000003e8,
	0x00000401, 0x00000414, 0x00000430, 0x00000446,
	0x00000465, 0x0000047f, 0x000004a5, 0x000004b1,
	0x000004d3, 0x000004ef, 0x0000050c, 0x00000524,
	0x0000053c, 0x00000540, 0x00000542, 0x00000553,
	0x00000569, 0x000005e9, 0x000005f0, 0x00000603,
	0x0000060a, 0x0000061c, 0x00000628, 0x0000062f,
	0x00000639, 0x0000063d, 0x00000644, 0x00000652,
	// Entry 40 - 5F
	0x00000662, 0x00000672, 0x0000067c, 0x0000068d,
	0x000006a0, 0x000006a7, 0x000006b1, 0x000006d3,
	0x000006ec, 0x000006ff, 0x00000718, 0x00000727,
	0x0000072e, 0x0000073e, 0x00000751, 0x0000075d,
	0x00000769, 0x00000772, 0x000007a7, 0x00000848,
	0x00000854, 0x0000085b, 0x00000867, 0x00000877,
	0x0000088d, 0x000008b1, 0x000008ca, 0x000008da,
	0x000008fb, 0x0000091a, 0x0000092d, 0x00000960,
	// Entry 60 - 7F
	0x0000096a, 0x0000097a, 0x0000098a, 0x0000099a,
	0x000009a1, 0x000009a8, 0x000009b4, 0x000009c0,
	0x000009cf, 0x000009d6, 0x000009e3, 0x00000a12,
	0x00000a22, 0x00000a38, 0x00000a45, 0x00000a74,
	0x00000a89, 0x00000aa1, 0x00000ace, 0x00000ae4,
	0x00000af4, 0x00000b01, 0x00000b13, 0x00000b2b,
	0x00000b37, 0x00000b4e, 0x00000b60, 0x00000b6f,
	0x00000b7e, 0x00000b92, 0x00000bad, 0x00000bc7,
	// Entry 80 - 9F
	0x00000beb, 0x00000bf2, 0x00000c03, 0x00000c5c,
	0x00000c63, 0x00000c6f, 0x00000c87, 0x00000c94,
	0x00000ca7, 0x00000cca, 0x00000ce2, 0x00000d07,
	0x00000d1f, 0x00000d3a, 0x00000d56, 0x00000d72,
	0x00000d9c, 0x00000db8, 0x00000dc8, 0x00000de2,
	0x00000e0f, 0x00000e22, 0x00000e39, 0x00000e62,
	0x00000e77, 0x00000ea1, 0x00000ec7, 0x00000eda,
	0x00000ef6, 0x00000f09, 0x00000f26, 0x00000f6a,
	// Entry A0 - BF
	0x00000f86, 0x00000fa4, 0x00000fbd, 0x00000ff3,
	0x0000100b, 0x0000106c, 0x000010c1, 0x000010da,
	0x000010e7, 0x00001103, 0x00001128, 0x0000113e,
	0x00001177, 0x00001198, 0x000011b8, 0x000011da,
	0x00001202,
} // Size: 732 bytes

const zh_TWData string = "" + // Size: 4610 bytes
	...
	"\x02系統時鐘倒退了！\x02%[1]d 年\x02%[1]d 天\x02%[1]d 小時\x02%[1]d 分鐘\x02%[1]d 秒" +
	...
	"必須出現在段落中\x02必須要有一個值\x02[Interface] 中有無效選項\x02[Peer] 中有無效選項\x02Interfac" +
	"e 中必須要有一把私鑰\x02[未指定]\x02每個 Peer 都必須要有公鑰\x02讀取設定時發生錯誤\x02Interface 中的金鑰無效" +
	"\x02協定版本必須為 1\x02Peer 中的金鑰無效\x02、\x02 \x02關於 WireGuard\x02WireGuard logo" +
	" 圖片\x02應用程式版本： %[1]s\x0a後端程式（Go 實作）版本： %[2]s\x0aGo 版本： %[3]s\x0a作業系統： %[" +
	"4]s\x0a架構： %[5]s\x02關閉\x02♥ 捐贈！ (&D)\x02狀態\x02中斷連線 (&D)\x02連線 (&A)\x02公鑰" +
	...
	"： %[1]v\x02已有另一個同名的隧道「%[1]s」\x02無法匯入設定： %[1]v\x02已匯入隧道\x02已匯入 %[1]d 個隧" +
	"道\x02已匯入 %[1]d 個隧道（共 %[2]d 個）\x02無法建立隧道\x02刪除 %[1]d 個隧道\x02您確定要刪除 %[1]" +
	"d 個隧道嗎？\x02刪除隧道 - %[1]s\x02您確定要刪除隧道「%[1]s」嗎？\x02%[1]s\x0a\x0a您將無法復原此操作。" +
	"\x02無法刪除隧道\x02無法刪除隧道： %[1]s\x02無法刪除隧道\x02無法刪除 %[1]d 個隧道\x02隧道設定檔 (*.zip," +
	...
	"coded hpack field %+[1]v\x02設定的項目必須要有一個等號"

	// Total table size 61697 bytes (60KiB); checksum: 29A07B05
