...
func runAboutDialog(owner walk.Form) error {
	...
	showingAboutDialog.SetTitle(l18n.Sprintf("About SENTIENT-VPN"))
	...
	iv.MouseUp().Attach(func(x, y int, button walk.MouseButton) {
		if button == walk.LeftButton {
			win.ShellExecute(showingAboutDialog.Handle(), nil, windows.StringToUTF16Ptr("https://www.sentient-vpn.com/"), nil, nil, win.SW_SHOWNORMAL)
	...
	copyrightLbl.SetText("Copyright © 2015-2026 SENTIENT-VPN. All Rights Reserved.")
	...
	donatePB.Clicked().Attach(func() {
		...
		win.ShellExecute(showingAboutDialog.Handle(), nil, windows.StringToUTF16Ptr("https://www.sentient-vpn.com/donations/"), nil, nil, win.SW_SHOWNORMAL)
