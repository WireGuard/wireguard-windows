...
:installdeps
	...
	call :download wireguard-nt.zip https://download.wireguard.com/wireguard-nt/wireguard-nt-0.7.zip 78863b387518c2946e08b9e4e7c6125516697a845108186777d9af56522be2da || goto :error
	echo [+] Patching go
