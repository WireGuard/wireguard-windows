...
:installdeps
	...
	call :download wireguard-nt.zip https://download.wireguard.com/wireguard-nt/wireguard-nt-0.2.zip a994fa8660a7c1ada92547e0162c8e3b54fa494fc0994f2644052d6a6db163dc || goto :error
	echo [+] Patching go
