...
:installdeps
	...
	call :download wireguard-nt.zip https://download.wireguard.com/wireguard-nt/wireguard-nt-0.3.zip 6f88398cee22b562e8a20fea6572c2d5ec6c87d90f03e03ad609b26677e9d1e0 || goto :error
	echo [+] Patching go
